#This program is a LeafModel class for the MST package which trains MNL models
#through calling the mnlogit package.
#
...
importr('mnlogit')
pandas2ri.activate()
ro.r.source("newmnlogit.R") #rewrites some functions from the mnlogit package to accommodate varying choice sets
